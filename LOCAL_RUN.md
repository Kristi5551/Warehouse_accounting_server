...
Flyway автоматически применяет миграции V1–V9 при первом запуске сервера.

| Что создаётся  | Источник         |
|----------------|-----------------|
| Структура таблиц | Flyway V1–V7    |
| Демо-склад, категории, товары, остатки | Flyway V8 + V9 |
| Учётная запись администратора | Kotlin `InitialDataSeed` |
